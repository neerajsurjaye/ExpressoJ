 ...
 * 
 * @deprecated replaced by newer expresso class
 */
@Deprecated
public class OldExpresso implements IExpresso {

    /** The single object that will exist for the whole program. */
    @Getter
    private static OldExpresso expressoObj = null;
     ...
     */
    public static OldExpresso init() {
        ...
        DeploymentInfo serverBuilder = Servlets.deployment()
                .setClassLoader(OldExpresso.class.getClassLoader())
                .setContextPath("/")
